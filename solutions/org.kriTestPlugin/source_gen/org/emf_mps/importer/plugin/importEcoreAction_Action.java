...
public class importEcoreAction_Action extends BaseAction {
  private static final Icon ICON = null;

  public importEcoreAction_Action() {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    if (result == JFileChooser.APPROVE_OPTION) {
      ...
      EPackage ecoreModel = importEcoreAction_Action.this.getEcoreModel(ecoreFilename, event);
      System.out.println(ecoreModel.getName());
      importEcoreAction_Action.this.prettyPrintEPackage(ecoreModel, event);
    }
  }
  public EPackage getEcoreModel(String fileName, final AnActionEvent event) {
    ...
    Resource retResource = importEcoreAction_Action.this.getEcoreMetaModel(fileName, event);
