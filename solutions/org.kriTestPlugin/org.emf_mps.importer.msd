...
<solution name="org.emf_mps.importer" uuid="e6dc6717-1454-41ee-b1e1-a4ba4e611cc6" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    ...
    <modelRoot contentPath="${module}" type="java_classes">
      <sourceRoot location="ecore-2.1.0.jar" />
      <sourceRoot location="ecore-xmi-2.1.0.jar" />
      <sourceRoot location="common-2.1.0.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
    <stubModelEntry path="${module}/ecore-2.1.0.jar" />
    <stubModelEntry path="${module}/ecore-xmi-2.1.0.jar" />
    <stubModelEntry path="${module}/common-2.1.0.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
